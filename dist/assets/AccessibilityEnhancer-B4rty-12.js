import{r as h}from"./index-Dy6chKJT.js";function g(){return h.useEffect(()=>{const r=()=>{if(!document.querySelector("#skip-links")){const e=document.createElement("div");e.id="skip-links",e.innerHTML=`
          <a 
            href="#main-content" 
